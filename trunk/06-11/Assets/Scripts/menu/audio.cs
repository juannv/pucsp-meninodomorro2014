...
public class audio : MonoBehaviour {
	...
	void OnGUI()
	{
		volumeSlider = GUI.HorizontalSlider(new Rect(Screen.width/2 + 355, Screen.height/2 - 75, 100, 5), volumeSlider, 0.0F, 10.0F);	// posicao da barra, tamanho da barra e valores de inicio/fim
		AudioListener.volume = 0.1f * volumeSlider;						//volume igual a 0.1 vezes a posicao da barra
