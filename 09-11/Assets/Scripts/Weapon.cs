...
public class Weapon : MonoBehaviour {
	...
	public string pontuacao = "000";
	
	public bool isShooting = false;		
	//	private Animator animator;				// inicia um animator
	...
	void Awake () {
		...
		firePoint = transform.FindChild ("FirePoint");		// encontrar a origem do raycast na hierarquia do objeto que possui este scrip		
	}
